...
from models.roi_head_FGBGda import SeqRoIHeadsDa
from models.da_FGBGhead import DomainAdaptationModule
...
class SeqNetDa(nn.Module):
    ...
    def forward(
        ...
        (da_fgins_feas_s, da_fgins_labels_s, da_bgins_feas_s, da_bgins_labels_s,
        da_fgins_feas_s_before, da_fgins_labels_s_before,
        da_bgins_feas_s_before, da_bgins_labels_s_before,) = self.roi_heads.extract_da(
        ...
        # )
        (da_fgins_feas_t, da_fgins_labels_t, da_bgins_feas_t, da_bgins_labels_t,
        da_fgins_feas_t_before, da_fgins_labels_t_before,
        da_bgins_feas_t_before, da_bgins_labels_t_before,) = self.roi_heads.extract_da(
           features_t, proposals_t, images_t.image_sizes, targets_t
        )
        ...
        if self.da_heads:
            da_losses_s = self.da_heads(
                ...
                da_fgins_feas_s_before,
                da_fgins_labels_s_before,

                da_bgins_feas_s_before,
                da_bgins_labels_s_before,
            ...
            da_losses_t = self.da_heads(
                ...
                da_fgins_feas_t_before,
                da_fgins_labels_t_before,

                da_bgins_feas_t_before,
                da_bgins_labels_t_before,
        ...
        da_losses_t["loss_da_instance_fg_t"] = da_losses_t.pop("loss_da_instance_fg")
        da_losses_t["loss_da_instance_bg_t"] = da_losses_t.pop("loss_da_instance_bg")
        da_losses_t["loss_da_consistency_fg_t"] = da_losses_t.pop("loss_da_consistency_fg")
        da_losses_t["loss_da_consistency_bg_t"] = da_losses_t.pop("loss_da_consistency_bg")
